...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans selection:text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center gap-2">
              ...
              <button onClick={() => scrollToSection('how-it-works')} className="text-gray-700 hover:text-teal-600 px-4 py-2 rounded-lg font-medium transition-all duration-200">How It Works</button>
              <button onClick={() => scrollToSection('about')} className="text-gray-700 hover:text-teal-600 px-4 py-2 rounded-lg font-medium transition-all duration-200">About</button>
              <Link to="/login" className="ml-4 bg-gradient-to-r from-teal-600 to-teal-700 text-white font-bold px-6 py-2.5 rounded-xl hover:from-teal-700 hover:to-teal-800 shadow-lg hover:shadow-teal-500/30 transition-all duration-200 flex items-center gap-2">
                Login
                <ArrowRight size={16} />
              </Link>
            </div>
      ...
      <section id="home" className="relative pt-20 pb-32 overflow-hidden min-h-[90vh] flex items-center">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl animate-fade-in-up">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-teal-500/20 border border-teal-400/30 text-teal-300 font-medium text-sm mb-6 backdrop-blur-sm shadow-xl shadow-teal-500/10">
            ...
            <h1 className="text-5xl md:text-7xl font-extrabold text-white tracking-tight mb-6 leading-tight">
              Manage Spaces.<br/> 
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-400 to-emerald-400">Save Energy.</span><br/>
              Study Better.
            </h1>
            ...
            <div className="flex flex-wrap gap-4">
              <Link 
                to="/register"
                className="px-8 py-4 text-lg font-bold rounded-2xl text-white bg-gradient-to-r from-teal-500 to-teal-600 hover:from-teal-600 hover:to-teal-700 shadow-xl hover:shadow-teal-500/40 hover:-translate-y-1 transition-all duration-300 flex items-center gap-2"
              >
                Get Started
                <ArrowRight size={20} />
              </Link>
      ...
      <section id="features" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { title: 'Smart Booking', icon: ShieldCheck, desc: 'Reserve rooms & labs instantly with real-time availability.', color: 'from-teal-500 to-emerald-600' },
              ...
              <div 
                key={idx} 
                className="bg-white rounded-3xl p-8 hover:shadow-2xl hover:shadow-teal-500/10 hover:-translate-y-2 transition-all duration-300 border border-teal-50 hover:border-teal-200 group hover:bg-teal-50/30 animate-fade-in-up"
      ...
      <section id="how-it-works" className="py-24 bg-gradient-to-br from-teal-50 to-emerald-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 animate-fade-in-up">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              { step: '03', title: 'Issue Resolved', desc: 'Get notified when it\'s fixed. Rate the service to help us improve!', icon: Star, color: 'bg-teal-500' }
            ].map((item, idx) => (
              <div key={idx} className="relative bg-white rounded-3xl p-8 shadow-xl shadow-teal-900/5 hover:shadow-2xl hover:shadow-teal-500/20 hover:-translate-y-2 transition-all duration-300 border border-transparent hover:border-teal-100 group animate-fade-in-up" style={{ animationDelay: `${idx * 150}ms` }}>
                <div className={`absolute -top-4 left-8 ${item.color} text-white w-12 h-12 rounded-xl flex items-center justify-center font-bold text-xl shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                  {item.step}
                </div>
                <div className="mt-6">
      ...
      <section id="about" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            {/* Mission */}
            <div className="bg-gradient-to-br from-teal-800 via-teal-700 to-emerald-600 rounded-3xl p-12 text-white shadow-2xl overflow-hidden relative hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 cursor-pointer group animate-fade-in-up">
              <div className="absolute top-0 right-0 -mt-16 -mr-16 opacity-10 group-hover:opacity-20 transition-opacity group-hover:rotate-12 transform duration-700">
                <Leaf className="w-64 h-64" />
              </div>
              <div className="absolute bottom-0 left-0 w-full h-2 bg-gradient-to-r from-teal-300 to-emerald-300"></div>
              <div className="relative z-10">
                ...
                <div className="mt-8 flex gap-6">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-sm text-teal-200">Energy Saved</div>
                  </div>
                  <div className="text-center">
            ...
            <div className="animate-fade-in-up" style={{ animationDelay: '200ms' }}>
                ...
                {[
                  ...
                  <li key={idx} className="flex items-start group">
                    <div className="flex-shrink-0">
                      <div className="h-10 w-10 bg-teal-100 rounded-xl flex items-center justify-center group-hover:bg-teal-500 transition-colors duration-300">
                        <Check className="h-5 w-5 text-teal-600 group-hover:text-white transition-colors" />
                      </div>
                    </div>
              ...
              <div className="mt-12 pt-8 border-t border-gray-200">
                <div className="grid grid-cols-2 gap-6">
                  <div className="bg-gradient-to-br from-teal-50 to-emerald-50 rounded-2xl p-6 border border-teal-100 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                  ...
                  <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl p-6 border border-blue-100 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                    <div className="flex items-center gap-4 mb-3">
      ...
      {/* CTA Section */}
      <section className="py-24 bg-gradient-to-r from-teal-600 via-teal-500 to-emerald-500 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 text-center animate-fade-in-up">
          ...
          <p className="text-xl text-teal-100 mb-10 max-w-2xl mx-auto">Join thousands of students who are making a difference. Report issues, track progress, and help build a better university.</p>
          <div className="flex flex-wrap justify-center gap-4">
            <Link 
              to="/register"
              className="px-10 py-4 text-lg font-bold rounded-2xl text-teal-600 bg-white hover:bg-gray-100 shadow-xl hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 flex items-center gap-2"
            >
              Get Started
              <ArrowRight size={20} />
            </Link>
          ...
          <div className="grid md:grid-cols-4 gap-12">
            ...
            <div className="md:col-span-2">
              ...
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 bg-gray-800 hover:bg-teal-600 rounded-lg flex items-center justify-center text-gray-400 hover:text-white transition-all duration-200">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><button onClick={() => scrollToSection('home')} className="text-gray-400 hover:text-teal-400 transition-colors">Home</button></li>
                ...
                <li><button onClick={() => scrollToSection('how-it-works')} className="text-gray-400 hover:text-teal-400 transition-colors">How It Works</button></li>
                <li><Link to="/login" className="text-gray-400 hover:text-teal-400 transition-colors">Report Issue</Link></li>
              </ul>
            </div>

...
import { Leaf, Globe, Zap, ShieldCheck, GraduationCap, Check, Users, Clock, Star, Mail, Phone, MapPin, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 font-sans selection:text-white">
      ...
      <nav className="fixed top-0 left-0 w-full z-50 bg-white shadow-md">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <Link
            to="/auth"
            className="bg-teal-600 hover:bg-teal-700 text-white px-5 py-2 rounded-xl shadow-md transition-all duration-300 hover:scale-105"
          >
            Sign In
          </Link>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <img 
          ...
          className="absolute w-full h-full object-cover animate-[zoom_20s_linear_infinite]"
        />
        ...
        <div className="relative z-10 text-center px-4">
          <h1 className="text-4xl md:text-6xl font-bold text-white drop-shadow-lg">
            Smart Campus<br/>
            <span className="text-teal-400">Facility Management</span>
          </h1>
          <p className="text-gray-300 mt-4 text-lg">
            Efficient. Sustainable. Connected.
          </p>
        </div>
      </section>
      ...
      <section id="features" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              { title: 'Smart Booking', icon: ShieldCheck, desc: 'Reserve rooms & labs instantly with real-time availability.', color: 'from-teal-500 to-teal-600' },
      ...
      <section id="how-it-works" className="py-24 bg-gradient-to-br from-teal-50 to-teal-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
      ...
      <section id="about" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            {/* Mission */}
            <div className="bg-gradient-to-br from-teal-800 via-teal-700 to-teal-600 rounded-3xl p-12 text-white shadow-2xl overflow-hidden relative hover:shadow-3xl hover:-translate-y-2 transition-all duration-500 cursor-pointer group">
              <div className="absolute top-0 right-0 -mt-16 -mr-16 opacity-10 group-hover:opacity-20 transition-opacity">
                <Leaf className="w-64 h-64" />
              </div>
              <div className="absolute bottom-0 left-0 w-full h-2 bg-gradient-to-r from-teal-300 to-teal-300"></div>
            ...
            <div>
              ...
              <div className="mt-12 pt-8 border-t border-gray-200">
                <div className="grid grid-cols-2 gap-6">
                  <div className="bg-gradient-to-br from-teal-50 to-teal-50 rounded-2xl p-6 border border-teal-100">
      ...
      {/* CTA Section */}
      <section className="py-24 bg-gradient-to-r from-teal-600 via-teal-500 to-teal-500 relative overflow-hidden">
          ...
          <div className="grid md:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link to="/auth" className="text-gray-400 hover:text-teal-400 transition-colors">Home</Link></li>
                <li><Link to="/auth" className="text-gray-400 hover:text-teal-400 transition-colors">Login</Link></li>
                <li><Link to="/auth" className="text-gray-400 hover:text-teal-400 transition-colors">About</Link></li>
              </ul>
            </div>
